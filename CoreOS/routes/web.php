...
//                ->name('admin.emergency-contacts.index');
    ...
    Route::post('/pto-requests/{ptoRequest}/approve', [PtoApprovalController::class, 'approve'])
        ->name('pto.requests.approve');

    Route::post('/pto-requests/{ptoRequest}/deny', [PtoApprovalController::class, 'deny'])
