        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="space-y-6 p-4">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    {/* Left Column - Company Updates and Schedule */}
                    <div className="space-y-6">
                        ...
                        <Card>
                            <CardHeader className="flex items-center gap-2 mb-4">
                                ...
                                <CardTitle className="text-lg font-semibold">Company Events</CardTitle>
                            </CardHeader>
                            <CardContent className="border-sidebar-border/70 dark:border-sidebar-border relative min-h-[800px] overflow-hidden rounded-xl border bg-card">
                    ...
                    {/* Right Column - Sales Performance and Total Sales This Year */}
                    <div className="space-y-6">
