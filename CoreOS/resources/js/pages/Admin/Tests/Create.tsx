...
export default function CreateTest({ module }: Props) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: 'Create Test',
            href: `/admin/modules/${module.id}/tests/create`,
        },
    ];

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('admin.modules.tests.store', module.id));
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Create Test - ${module.title}`} />
            ...
            <div className="flex h-full max-h-screen flex-1 flex-col gap-4 rounded-xl p-4">
                <div className="flex items-center mb-6">
                    ...
                    <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Create Final Test for {module.title}</h1>
                </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="flex justify-end space-x-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="px-6 py-2 bg-yellow-600 hover:bg-yellow-700 dark:bg-yellow-500 dark:hover:bg-yellow-600 text-white rounded-lg font-medium transition duration-200 disabled:opacity-50"
                            >
