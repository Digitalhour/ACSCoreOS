// resources/js/pages/Admin/Questions/Create.tsx
...
export default function CreateQuestion({ quiz }: Props) {
            ...
            <div className="flex h-full max-h-screen flex-1 flex-col gap-4 rounded-xl p-4">
                <div className="flex items-center mb-6">
                    ...
                    <div className="flex items-center">
                        ...
                        <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Add Question to {quiz.title}</h1>
                    </div>
                </div>
