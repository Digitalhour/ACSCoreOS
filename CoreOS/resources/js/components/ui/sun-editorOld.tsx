    ...
    useEffect(() => {
            ...
            templates: [

                {
                    ...
                    html: '<div style="max-width: 800px; margin: 0 auto; font-family: \'Times New Roman\', serif; background: white; padding: 20px; box-sizing: border-box;"> \n' +
                        ...
                        ' \n' +
                        '<div style="display: flex; justify-content: space-between; align-items: center; margin-top: 10px; font-size: clamp(12px, 2vw, 14px); flex-wrap: wrap; gap: 10px;">' +
                        ' <span><strong>Date:</strong> 12/11/2024</span> <span><strong>SCHOOL HOUSE</strong></span> <span><strong>Vol. No.:</strong> 2</span> </div>\n' +
                        ' </div>\n' +
                        ' \n' +
                        '<!-- Main Headline --> \n' +
                        '<div style="text-align: center; margin-bottom: 25px;"> \n' +
                        '<h2 style="font-size: clamp(20px, 3.5vw, 28px); font-weight: bold; letter-spacing: 1px; margin: 0; padding: 0;">' +
                ...
                },
                {
                    ...
                    html: '<!-- Header Image -->\n' +
                        '<div style="width: 75%;">\n' +
                        '    <figure style="width: 100%;">\n' +
                        '        <img src="https://lh7-rt.googleusercontent.com/docsz/AD_4nXfI1p0J1vXWw0Bommlq-az6ZYwbJYcgnjn56VOO4vej3HGusnCA--_x_ZKV9y47PShcTsYRfREl0cJmKM0lEl17dd4tJgp-1Kx1D8Y1iGienTzuwWUNRW5RmGrK61qSJYZdEAZM?key=T42eGeNnJg8vL8eC-eEDgw"\n' +
                        '             alt="ACS BlitzBrief Header" style="width: 100%; height: auto; display: block; margin-bottom: 20px;" data-proportion="true" data-percentage="100%,auto" width="100%" height="auto" data-size="100%,auto" data-align="none" data-file-name="AD_4nXfI1p0J1vXWw0Bommlq-az6ZYwbJYcgnjn56VOO4vej3HGusnCA--_x_ZKV9y47PShcTsYRfREl0cJmKM0lEl17dd4tJgp-1Kx1D8Y1iGienTzuwWUNRW5RmGrK61qSJYZdEAZM?key=T42eGeNnJg8vL8eC-eEDgw" data-file-size="0" origin-size="1600,466" data-origin="100%,auto" data-index="0">\n' +
                        '    </figure>\n' +
                        '</div>\n' +
                        '\n' +
                        '<div style=" margin: 0 auto; font-family: Arial, sans-serif; background: white; line-height: 1.6;">\n' +
                        '    <!-- Main Content -->\n' +
                        ...
                        '            <div style="flex: 1; min-width: 250px; padding-left: 25px;">\n' +
                        ...
                        '                        <img src="https://placehold.co/273x364/" alt="Meyer Center construction project" data-proportion="true" width="273" height="364" data-size="273px,364px" data-align="" data-file-name="" data-file-size="0" origin-size="273,364" data-origin="273px,364px" style="width: 273px; height: 364px;" data-index="1">\n' +
                        '                    </figure>\n' +
                        '                </div>\n' +
                        '            </div>\n' +
                        '\n' +
                        ...
                        '                        <div class="se-component se-image-container __se__float- __se__float-none" style="">\n' +
                        '                            <figure style="">\n' +
                        '                                <img src="https://placehold.co/494x300" data-index="2" data-file-name="494x300" data-file-size="0" origin-size="494,300" data-origin="," data-size="," data-rotate="" data-rotatex="" data-rotatey="" width="494" height="300" data-align="none" data-percentage="auto,auto" style="">\n' +
                        '                            </figure>\n' +
                        '                        </div>\n' +
                        '                    </div>\n' +
                        '\n' +
        ...
        if (onTemplateChange) {
            ...
            sunEditorRef.current.onChange = (contents: any) => {
                ...
                if (contentChanged) {
                    // Detect which template was applied based on content
                    if (stringContent.includes('ACS NEWSLETTER') || stringContent.includes('SPRING BREAK AND UPCOMING EVENTS')) {
                        setTimeout(() => onTemplateChange('News Paper 1 page'), 100);
                    } else if (stringContent.includes('ACS BlitzBrief') || stringContent.includes('BlitzBrief Header')) {
                        setTimeout(() => onTemplateChange('Blitz Brief'), 100);
                    }
                }
            ...
            if (editorContainer) {
                const handleTemplateClick = (event: any) => {
                    ...
                    if (target && target.textContent) {
                        if (target.textContent.includes('News Paper 1 page')) {
                            // Delay to let the template content load
                            setTimeout(() => {
                                const content = sunEditorRef.current?.getContents() || '';
                                if (content.includes('ACS NEWSLETTER')) {
                                    onTemplateChange('News Paper 1 page');
                                }
                            }, 200);
                        } else if (target.textContent.includes('Blitz Brief')) {
                            setTimeout(() => {
                                const content = sunEditorRef.current?.getContents() || '';
                                if (content.includes('ACS BlitzBrief')) {
                                    onTemplateChange('Blitz Brief');
                                }
                            }, 200);
                        }
                    }
